defmodule AnonMessagesWeb.UserAuth do
  use AnonMessagesWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  alias AnonMessages.Accounts

  # Make the remember me cookie valid for 60 days.
  # If you want bump or reduce this value, also change
  # the token expiry itself in UserToken.
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_anon_messages_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AnonMessagesWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule AnonMessagesWeb.PageLive do
        use AnonMessagesWeb, :live_view

        on_mount {AnonMessagesWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AnonMessagesWeb.UserAuth, :ensure_authenticated}] do
